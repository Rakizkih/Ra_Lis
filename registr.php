            ...
            <?php 
                ...
                if( isset($data['reg'])) //если была нажата кнопка зарегистрироваться
                {
                    ...
                    if(empty($errors) ) // если ошибок нет - регистрируем
                    {
                        ...
                        echo '<div style="color: white; font-size: 35px; text-align: center; margin: 3rem;">Заявка успешно зарегистрирована!</div>';
            ...
            ?>
                <form action="" method="post">
                    <h1 class="login">Регистрация</h1>
                        ...
                        <center><a href="/index.html" class="a">На главную</a></center>                    
